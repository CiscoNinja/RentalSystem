...
namespace RentalSystem.Migrations
{
    ...
    [Migration("20210629165747_IMustHaveTenanMigration")]
    partial class IMustHaveTenanMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("RentalSystem.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("RentalSystem.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("RentalSystem.Entities.Client", b =>
                {
                    b.OwnsOne("RentalSystem.Entities.Address", "Address", b1 =>
                        {
