...
{
    public abstract class RentalSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static RentalSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(RentalSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<RentalSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<RentalSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<RentalSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<RentalSystemDbContext, Task<T>> func)
        {
            T result;
